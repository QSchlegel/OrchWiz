...
| `CTRL-INCIDENT-RESPONSE` | Incident response case log with Aurora-compatible `.fox` import/export, Vault snapshots, and integration evidence artifacts. | A.5.24, A.5.27 | CC7.3, CC7.4 | Security Operations | `OWZ-Vault/03-Technical/Incident-Response-Runbook.md`; `OWZ-Vault/00-Inbox/Security-Incidents/`; `node/src/lib/security/incident-response/`; `node/src/app/api/security/incidents/` |
