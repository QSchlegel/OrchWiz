...
export const SYSTEM_PERMISSION_POLICY_PRESETS: PermissionPolicyPreset[] = [
  ...
  {
    slug: "quartermaster-executive-workspace",
    name: "Quartermaster Executive Workspace",
    description: "Quartermaster profile allowing Codex CLI workspace-write execution for direct repo fixes.",
    rules: [
      { commandPattern: "codex exec * --dangerously-bypass-approvals-and-sandbox*", type: "bash_command", status: "deny", sortOrder: 10 },
      { commandPattern: "codex exec * --sandbox danger-full-access*", type: "bash_command", status: "deny", sortOrder: 20 },
      { commandPattern: "codex exec --sandbox read-only --skip-git-repo-check *", type: "bash_command", status: "allow", sortOrder: 100 },
      { commandPattern: "*codex* exec --sandbox read-only --skip-git-repo-check *", type: "bash_command", status: "allow", sortOrder: 110 },
      { commandPattern: "codex exec --sandbox workspace-write --skip-git-repo-check *", type: "bash_command", status: "allow", sortOrder: 120 },
      { commandPattern: "*codex* exec --sandbox workspace-write --skip-git-repo-check *", type: "bash_command", status: "allow", sortOrder: 130 },
      { commandPattern: "codex exec *", type: "bash_command", status: "deny", sortOrder: 900 },
      { commandPattern: "*", type: "bash_command", status: "deny", sortOrder: 1000 },
    ],
  },
  {
    slug: "quartermaster-executive-full",
    name: "Quartermaster Executive Full Access",
    description: "Quartermaster profile allowing Codex CLI danger-full-access execution for host-level debugging.",
    rules: [
      { commandPattern: "codex exec * --dangerously-bypass-approvals-and-sandbox*", type: "bash_command", status: "deny", sortOrder: 10 },
      { commandPattern: "codex exec --sandbox read-only --skip-git-repo-check *", type: "bash_command", status: "allow", sortOrder: 100 },
      { commandPattern: "*codex* exec --sandbox read-only --skip-git-repo-check *", type: "bash_command", status: "allow", sortOrder: 110 },
      { commandPattern: "codex exec --sandbox workspace-write --skip-git-repo-check *", type: "bash_command", status: "allow", sortOrder: 120 },
      { commandPattern: "*codex* exec --sandbox workspace-write --skip-git-repo-check *", type: "bash_command", status: "allow", sortOrder: 130 },
      { commandPattern: "codex exec --sandbox danger-full-access --skip-git-repo-check *", type: "bash_command", status: "allow", sortOrder: 140 },
      { commandPattern: "*codex* exec --sandbox danger-full-access --skip-git-repo-check *", type: "bash_command", status: "allow", sortOrder: 150 },
      { commandPattern: "codex exec *", type: "bash_command", status: "deny", sortOrder: 900 },
      { commandPattern: "*", type: "bash_command", status: "deny", sortOrder: 1000 },
    ],
  },
