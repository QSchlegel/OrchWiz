...
export function DeploymentNode({ data, selected }: NodeProps<DeploymentNodeData>) {
  return (
    <div
      className={`min-w-[180px] rounded-xl border px-3 py-2.5 backdrop-blur ${
        selected
          ? "border-indigo-400/70 bg-indigo-500/10 shadow-[0_0_20px_rgba(99,102,241,0.35)]"
