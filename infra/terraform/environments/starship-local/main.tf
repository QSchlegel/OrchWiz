...
module "starship_minikube" {
  ...
  openclaw_station_count       = var.openclaw_station_count
...
output "spacebot_enabled" { value = module.starship_minikube.spacebot_enabled }
output "spacebot_service_name" { value = module.starship_minikube.spacebot_service_name }
